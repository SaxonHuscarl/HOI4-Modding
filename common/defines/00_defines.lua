...
NIndustrialOrganisation = {
	...
	FUNDS_FOR_SIZE_UP = 1250,					-- Funds needed for a MIO to increment its size and get points to unlock traits
	...
	DESIGN_TEAM_CHANGE_XP_COST = 10,				-- Flat cost added to the XP cost of a new equipment design
